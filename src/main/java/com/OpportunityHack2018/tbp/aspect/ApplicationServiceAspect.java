...
public class ApplicationServiceAspect {
    ...
    @AfterReturning(value = "execution(* com.OpportunityHack2018.tbp.services.ApplicantService.apply(int,java.lang.String)) && args(jobId,applicantId)",returning = "statusCode")
